...
public record ImportPendingAccountCommand(int Id, ImportPendingAccountDto ImportPendingAccountDTO)
    : IRequest<Result<object>>;

public class ImportPendingAccountCommandHandler(
    IPendingAccountRepository pendingAccountRepository,
