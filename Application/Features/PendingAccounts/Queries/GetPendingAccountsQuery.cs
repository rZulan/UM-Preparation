...
public record GetPendingAccountsQuery(GenericFiltersDto GenericFiltersDTO, Sort Sort)
    : IRequest<GetAllResult<List<GetPendingAccountDto>>>;
    ...
    : IRequestHandler<GetPendingAccountsQuery, GetAllResult<List<GetPendingAccountDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            SortColumns =
                ["id", "employeeprefix", "employeeid", "username", "firstname", "middlename", "lastname", "suffix"],
        ...
        return GetAllResult<List<GetPendingAccountDto>>.Success(result, paginationInfo: paginationInfo,
            sortInfo: sortInfo);
    }
}