...
public record AddWarehouseReceivingCommand(int? UserId, AddWarehouseReceivingDto AddWarehouseReceivingDTO)
    : IRequest<Result<object>>;

public class AddWarehouseReceivingCommandHandler(
