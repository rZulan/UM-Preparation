...
public interface IWarehouseReceivingRepository
{
    ...
    Task<List<WarehouseReceiving>> GetAllAsync(GenericFiltersDto genericFiltersDTO, Sort sort,
    ...
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    Task<bool> ProductHasAvailableReserve(int warehouseId, int productId, decimal quantity,
        CancellationToken cancellationToken);
    ...
    /// <param name="quantity">The quantity to check for availability.</param>
    /// <param name="cancellationToken">Token to cancel the operation.</param>
    Task<List<AvailableMoveOrderProductWarehouseReceivingsDto>> GetProductAffectedWarehouseReceivings(int warehouseId,
        int productId, decimal quantity, CancellationToken cancellationToken);
}