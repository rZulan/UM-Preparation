...
public class Result<T>
{
    ...
    {
        return new Result<T>(true, value, message ?? "Operation successful.", statusCode);
    }
    ...
    {
        return new Result<T>(false, default, message ?? "Operation failed.", statusCode);
    }
    ...
    /// <param name="message">Optional failure message.</param>
    /// <param name="statusCode">HTTP status code. Defaults to <see cref="HttpStatusCode.BadRequest" />.</param>
    public static Result<T> FailureWithValue(T? value, string? message = null,
        HttpStatusCode? statusCode = HttpStatusCode.BadRequest)
    {
        return new Result<T>(false, value, message ?? "Operation failed.", statusCode);
    }
}
...
{
    protected GetAllResult(bool isSuccess, T? value, string? message, HttpStatusCode? statusCode,
        PaginationInfo? paginationInfo = null, SortInfo? sorting = null)
    {
        IsSuccess = isSuccess;
        StatusCode = statusCode;
        Value = value;
    ...
    public static GetAllResult<T> Success(T? value, string? message = null,
        HttpStatusCode? statusCode = HttpStatusCode.OK, PaginationInfo? paginationInfo = null,
        SortInfo? sortInfo = null)
    {
        return new GetAllResult<T>(true, value, message ?? "Operation successful.", statusCode, paginationInfo,
            sortInfo);
    }
    ...
    /// <param name="paginationInfo">Optional pagination metadata.</param>
    /// <param name="sortInfo">Optional sort metadata.</param>
    public static GetAllResult<T> Failure(string? message = null,
        HttpStatusCode? statusCode = HttpStatusCode.BadRequest, PaginationInfo? paginationInfo = null,
        SortInfo? sortInfo = null)
    {
        return new GetAllResult<T>(false, default, message ?? "Operation failed.", statusCode, paginationInfo,
            sortInfo);
    }
    ...
    /// <param name="paginationInfo">Optional pagination metadata.</param>
    /// <param name="sortInfo">Optional sort metadata.</param>
    public static GetAllResult<T> FailureWithValue(T? value, string? message = null,
        HttpStatusCode? statusCode = HttpStatusCode.BadRequest, PaginationInfo? paginationInfo = null,
        SortInfo? sortInfo = null)
    {
        return new GetAllResult<T>(false, value, message ?? "Operation failed.", statusCode, paginationInfo, sortInfo);
    }
}